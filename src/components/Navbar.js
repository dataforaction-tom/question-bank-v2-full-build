      ...
      <div className="container mx-auto px-4 max-w-full">
        ...
        <div className="hidden sm:flex flex-col lg:flex-row justify-between items-center">
          ...
          <nav className="flex items-center flex-wrap justify-center gap-2">
            ...
            {session ? (
              <>
                <Link to="/submit-question" className="block px-3 py-2 text-lg font-bold text-[#f4f4f4] hover:text-yellow-300 rounded transition">
                  Submit Question
                </Link>
                <Link to="/create-group" className="block px-3 py-2 text-lg font-bold text-[#f4f4f4] hover:text-yellow-300 rounded transition">
                  Create Group
                </Link>
                <Link to="/group-dashboard" className="block px-3 py-2 text-lg font-bold text-[#f4f4f4] hover:text-yellow-300 rounded transition">
                  Group Dashboard
                </Link>
                <Link to="/profile" className="block px-3 py-2 text-lg font-bold text-[#f4f4f4] hover:text-yellow-300 rounded transition">
                  Profile
                </Link>
                <button onClick={handleLogout} className="block px-3 py-2 text-lg font-bold text-[#f4f4f4] hover:text-yellow-300 rounded transition">
                  Logout
                </button>
              </>
            ) : (
              <>
                <Link to="/signin" className="block px-3 py-2 text-lg font-bold text-[#f4f4f4] hover:text-yellow-300 rounded transition">
                  Sign In
                </Link>
                <Link to="/signup" className="block px-3 py-2 text-lg font-bold text-[#f4f4f4] hover:text-yellow-300 rounded transition">
                  Sign Up
                </Link>
              </>
            )}
